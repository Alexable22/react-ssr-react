...
function EditPostPage({ params }) {
    ...
    const [fetching, setFetching] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(true); // 初始加载数据的状态
    ...
    const [postId, setPostId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(''); // 存储文章ID
    // 修正：正确解析路由参数 + 捕获错误
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EditPostPage.useEffect": ()=>{
            const fetchData = {
                "EditPostPage.useEffect.fetchData": async ()=>{
                    try {
                        ...
                        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('加载编辑页失败：' + error.message);
                    // 可选：跳回首页（避免停留在错误页面）
                    // router.push('/');
                    } finally{
                        setFetching(false);
            ...
            }["EditPostPage.useEffect.fetchData"];
            fetchData();
        }
    }["EditPostPage.useEffect"], [
        params,
    ...
    const fetchPostData = async (id)=>{
        try {
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].get(`http://localhost:5000/api/posts/${id}`);
            if (res.data.success) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('获取文章详情失败：' + error.message);
        }
    };
    // 2. 提交更新
    const onFinish = async (values)=>{
        if (!postId) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].warning('文章ID无效');
        }
        setLoading(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].put(`http://localhost:5000/api/posts/${postId}`, values);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success('修改成功！');
            router.push(`/posts/${postId}`); // 跳转到文章详情页
            router.refresh();
        } catch (error) {
            console.error(error);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('修改失败：' + (error.response?.data?.message || error.message));
        } finally{
            setLoading(false);
        }
    };
...
_s(EditPostPage, "URmTBW16Lz7wiEP6sUxAliUtbTc=", false, function() {
    return [
...
//# sourceMappingURL=src_app_posts_%5Bid%5D_edit_page_ae4a9259.js.map