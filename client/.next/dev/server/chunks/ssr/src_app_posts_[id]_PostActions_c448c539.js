module.exports = [
"[project]/src/app/posts/[id]/PostActions.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const { confirm } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$modal$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__Modal$3e$__["Modal"];
function PostActions({ postId }) {
    ...
    const handleDelete = ()=>{
        confirm({
            ...
            onOk: async ()=>{
                try {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].delete(`http://localhost:5000/api/posts/${postId}`);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].success('删除成功');
                    router.push('/'); // 回到首页
                    router.refresh(); // 刷新数据
                } catch (error) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$antd$2f$es$2f$message$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$export__default__as__message$3e$__["message"].error('删除失败');
                }
            }
        });
    };
...
//# sourceMappingURL=src_app_posts_%5Bid%5D_PostActions_c448c539.js.map